# 1) Create a list of "person" dictionaries with a name, age and list of
...
# 4) Copy the person list such that you can safely edit the name of the first
#     person (without changing the original list).
new_list = [el.copy() for el in persons]
new_list[0]['name'] = 'Eddie'
print(new_list)

# 5) Unpack the persons of the original list into different variables and
