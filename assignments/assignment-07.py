...
class Food:
    ...
    def describe(self) -> None:
        print(f'I am a {self.__class__.__name__}. My name is {self.name} and my kind is {self.kind}')
    ...
    def describe2(cls) -> None:
        print(f'I am a Food. My name is {cls.name} and my kind is {cls.kind}')

    @staticmethod
    def describe3() -> None:
        print(f'I am a Food. My name is {Food.name} and my kind is {Food.kind}')
